                ...
                <div className="flex items-center justify-between sm:min-w-full">
                    ...
                    <div className="flex items-center justify-start w-1/2">
                        <a href="/" className="flex font-bold text-gray-700 items-center justify-center" >
                            <img src={logo} className={`my-4 duration-700 ${isShrunk ? "w-[12rem] lg:w-[8rem] sm:w-[3rem]" : "w-[8rem] lg:w-[6rem] sm:w-[2rem] "}`} />
                        </a>
                    </div>
                    ...
                    <div className="flex gap-3 min-h-full sm:gap-2 max-w-[80%]">
                        {/* primary */}
                        <motion.div className="md:hidden xl:text-[0.8rem] flex items-center justify-end gap-6 border-r border-r-primaryRed pr-2" initial={{ opacity: 0, scale: 1 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 3 }} >
